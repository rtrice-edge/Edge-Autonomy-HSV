...
class PurchaseRequest(models.Model):
    ...
    is_level_13_approved = fields.Boolean(default=False)
    is_level_14_approved = fields.Boolean(default=False)
    ...
    approver_level_1 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'dept_supv'), ('user_id', '!=', uid)]",
    ...
    approver_level_2 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'dept_mgr'), ('user_id', '!=', uid)]",
    ...
    approver_level_3 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'prog_mgr'), ('user_id', '!=', uid)]",
    ...
    approver_level_4 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'safety_mgr'), ('user_id', '!=', uid)]",
    ...
    approver_level_5 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'it_mgr'), ('user_id', '!=', uid)]",
    ...
    approver_level_6 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'sc_mgr'), ('user_id', '!=', uid)]",
    ...
    approver_level_7 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'dept_dir'), ('user_id', '!=', uid)]",
    ...
    approver_level_8 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'gm_coo'), ('user_id', '!=', uid)]",
    ...
    approver_level_9 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'cto'), ('user_id', '!=', uid)]",
    ...
    approver_level_10 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'cgo'), ('user_id', '!=', uid)]",
    ...
    approver_level_11 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'coo'), ('user_id', '!=', uid)]",
    ...
    approver_level_12 = fields.Many2one(
        ...
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'cpo'), ('user_id', '!=', uid)]",
    ...
    approver_level_13 = fields.Many2one(
        'purchase.request.approver', 
        string='CFO Approver',
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'cfo'), ('user_id', '!=', uid)]",
        help="CFO who will approve this request"
    )

    needs_approver_level_13 = fields.Boolean(
        compute='_compute_approvers_needed', default=False, store=True
    )

    approver_level_14 = fields.Many2one(
        'purchase.request.approver', 
        string='CEO Approver',
        tracking=True,
        ondelete='restrict',
        domain="[('manager_level', '=', 'ceo'), ('user_id', '!=', uid)]",
        help="CEO who will approve this request"
    )

    needs_approver_level_14 = fields.Boolean(
        compute='_compute_approvers_needed', default=False, store=True
    )
