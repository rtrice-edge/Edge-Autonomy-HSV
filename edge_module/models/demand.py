...
class Demand(models.Model):
    ...
    month_2 = fields.Float(string='Month 2', required=True)
    month_3 = fields.Float(string='Month 3', required=True)
    month_4 = fields.Float(string='Month 4', required=True)
    month_5 = fields.Float(string='Month 5', required=True)
    month_6 = fields.Float(string='Month 6', required=True)
    month_7 = fields.Float(string='Month 7', required=True)
